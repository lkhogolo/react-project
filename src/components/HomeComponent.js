        ...
        <div className="container">
                    ...
                    <Card className="bg-light mt-3">
                        <CardBody>
                            <blockquote className="blockquote">
                                <img className="card-img-top" src="/assets/images/sunset1.jpg" height="150" width="100%" alt="Sunset"/>
            ...
            <div className="row row-content align-items-center">
                <div className="col-sm-4">
                    <img src="/assets/images/sara3.jpg" alt="SJC"className="d-flex img-thumbnail"/>
                </div>
                <div className="col">
                    <p>
                    ...
                    <a role="button" href="/contactus"className="btn btn-lg btn-warning text-white align-center">Book Your Appointment</a>
                </div>
            </div>
            <div className="row row-content align-items-center">
                <div className="col-sm-8">
                    ...
                    <p> 
                        ...
                        in or help you get a better idea of who I am. </p>
                        <p>I welcome and encourage my clients 
